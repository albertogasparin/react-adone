...
Given a standard action, the arguments of the "inner" function called by Adone itself are the following:
...
This is useful in case you want to make the same data to be available to all actions, or to update the Store state when one of those props is changed ([see Container docs for more](../basics/container.md)).
